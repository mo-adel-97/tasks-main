import HrAttendancePage from '../../src/pages/HrAttendancePage';
import HrContractsPage from '../../src/pages/HrContractsPage';
import HrDepartmentsPage from '../../src/pages/HrDepartmentsPage';
import HrJobTitlesPage from '../../src/pages/HrJobTitlesPage';
import HrPermissionsPage from '../../src/pages/HrPermissionsPage';
import HrEmployeeHomePage from '../../src/pages/HrEmployeeHomePage';
...
window.fetch=async (input,init={})=>{
  ...
  if(url.includes('/api/hr/attendance?')) result={data:[{...employee,employeeName:employee.fullName,shiftGuid:'shift',shiftName:'الوردية الصباحية الطويلة',status:'Present',checkInAt:'2026-09-15T08:00:00',checkOutAt:'2026-09-15T16:00:00',workMinutes:480}],totalCount:1,stats:{totalEmployees:1,presentCount:1}};
  if(url.includes('/api/hr/contracts?'))result={data:[{...employee,employeeName:employee.fullName,contractGuid:'contract',contractType:'FullTime',status:'Active',startDate:'2026-01-01',endDate:'2026-12-31',basicSalary:5000}],totalCount:1};
  if(url.includes('user-permissions'))result={data:{humanResources:{canView:true,screens:{employees:true,departments:true,jobTitles:true,contracts:true,attendance:true,leaves:true,employeePermissions:true}}}};
...
const pages={HrAttendancePage:<HrAttendancePage/>,HrContractsPage:<HrContractsPage/>,HrDepartmentsPage:<HrDepartmentsPage/>,HrJobTitlesPage:<HrJobTitlesPage/>,HrPermissionsPage:<HrPermissionsPage/>,HrEmployeeHomePage:<HrEmployeeHomePage/>,leaves:<HrLeavesPage/>,employees:<HrEmployeesPage/>,admissions:<AdmissionRequestsReport/>,branches:<NavigationShell><BranchesDashboard/></NavigationShell>,refund:<RefundRequestDialog open student={{studentName:'طالب اختبار',nationalId:'1234567890',studentTel:'0501234567'}} apiBaseUrl="/api" onClose={()=>{}}/>};
