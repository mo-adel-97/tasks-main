...
const root=process.cwd(),out=path.join(root,'ui-review','theme','build');
const config={mode:'development',entry:path.join(root,'ui-review/theme/preview.jsx'),output:{path:out,filename:'preview.js'},devtool:false,
...
webpack(config,(err,stats)=>{
  ...
  }).listen(3102,'127.0.0.1',()=>console.log('UI fixture ready at http://127.0.0.1:3102'));
});
