...
const HrDepartmentsPage = () => {
  ...
  return (
    <NavigationShell variant="standard" mobileOpen={mobileSidebarOpen} onMobileClose={() => setMobileSidebarOpen(false)}><Box className="sstli-hr-dark-root"
      dir={PAGE_DIRECTION}
      sx={{
        minHeight: "100dvh",
        width: "100%",
        maxWidth: "100%",
        overflowX: "hidden",
        background: isDark ? theme.palette.background.default : "linear-gradient(180deg,#f7fbf9 0%,#ffffff 100%)",
