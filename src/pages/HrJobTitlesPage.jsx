...
export default function HrJobTitlesPage() {
  ...
  return (
    <NavigationShell variant="standard" mobileOpen={mobileSidebarOpen} onMobileClose={() => setMobileSidebarOpen(false)}><>
      <Box className="sstli-hr-dark-root" sx={{ ...navigationContentSx, ...uiLayout.scopeSx, bgcolor: theme.palette.mode === 'dark' ? theme.palette.background.default : soft, minHeight: "100vh" }}>
