      ...
      >
        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 0.5 }}>
          <Box sx={{ position: "relative", display: "inline-flex" }}>
            <CircularProgress size={56} thickness={4} sx={{ color: COLOR_SCHEME.primary, mb: 2 }} />
            <Box
              sx={{
                top: 0,
                left: 0,
            ...
            >
              <Person sx={{ fontSize: 22, color: COLOR_SCHEME.primary }} />
            </Box>
          </Box>
        </motion.div>
    ...
    <>
      ...
      <Box
        sx={{
          ...
          '& .MuiCardContent-root': {
            p: { xs: '12px !important', sm: '16px !important', md: '20px !important' }
          },
      ...
      >
        <Container maxWidth={false} sx={{ px: { xs: 0, sm: 0.25, md: 0.45 }, py: { xs: 0.15, sm: 0.3, md: 0.4 }, maxWidth: '1180px', mx: 'auto' }}>
          {/* Header */}
          ...
          {/* Tab content */}
          <Box sx={{ mt: { xs: 0.25, sm: 0.4, md: 0.5 } }}>
           {activeTab === 0 && (
  <OverviewTab
    user={user}
    tasks={tasks}
